    ...
    <button
        ...
        <div class="mt-4">
          ...
          <input
            ...
            v-model="username"
            class="block w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-green-500 dark:focus:border-green-500 focus:outline-none "
            type="email"
          />
        </div>
        ...
        <div class="mt-8">
          <button
            ...
            "
            class="w-full flex justify-center px-4 py-2 text-white disabled:opacity-50  bg-green-500 rounded-md hover:bg-green-600 "
          >
            <svg
              v-if="authenticating"
